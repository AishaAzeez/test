...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Capture login time
    const loggedIn = new Date().toLocaleString('en-US', { timeZone: 'Asia/Kolkata' });    
    const userData = { email, region, shift, loggedIn }; // Include loginTime in userData
    onLogin(userData);
    console.log(userData);
  
    if (!email || !region || !shift) {
