...
const Attendance = ({ user, onMarkAttendance, logoutTime }) => {
  const [attendanceMarked, setAttendanceMarked] = useState(false);
  const [showPopup, setShowPopup] = useState(false);
  ...
  const onLogout = async () => {
    try {
      ...
      const response = await updateAPI({
        email: user.email, // Pass user email to identify the user
        logoutTime: logoutTime // Pass logout time to update
      });
